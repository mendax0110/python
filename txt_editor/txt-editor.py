...
class TextEditor:
    ...
    def __init__(self, root):
        ...
        self.horizontal_scroll_bar = Scrollbar(root, orient=HORIZONTAL, bg="#3687ce", activebackground="#0056a1",
        ...
        # add the scroll bar to the text area
        self.vertical_scroll_bar = Scrollbar(root, orient=VERTICAL, bg="#3687ce", activebackground="#0056a1",
